...
NOTE: If you only with to use the application and do not want to look at the source code, click here: https://github.com/andreiidmt/Shapiro-Sim/releases/tag/v1.0
